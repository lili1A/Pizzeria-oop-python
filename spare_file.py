...
class PizzaShop(ABC):
    ...
    def create_custom_pizza(self) -> Pizza:
        ...
        topping_count = 0
        max_toppings = 4
        toppings_list = ['1', '2', '3', '4', '5', '6']

        while topping_count < max_toppings:
            topping = input(f"Enter topping #{topping_count + 1} (or 'done' to finish): ")
            if topping.lower() == 'done':
                break
            elif topping.lower() in toppings_list:
                print(f"Adding {topping} to your pizza")
                custom_pizza.add_topping(topping, 0)
                topping_count += 1
            else:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == 1:
            ...
            print("This id the mode for admin")
            break
        else:
...
# File "/Users/liliiagubaeva/Pizzeria-oop-python-1/new_app_pizzeria.py", line 3, in <module>
#     from admin import Admin
# ImportError: cannot import name 'Admin' from partially initialized module 'admin' (most likely due to a circular import) (/Users/liliiagubaeva/Pizzeria-oop-python-1/admin.py)